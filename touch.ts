...
namespace makerbit {
   ...
   * @param sensor the touch sensor to be checked, eg: TouchSensor.T1
  ...
  function getSensorIndexFromSensorBitField(touchSensorBit: TouchSensor) {
    ...
    let bit = TouchSensor.T1;
    for (let sensorIndex = 1; sensorIndex <= 12; sensorIndex++) {
   ...
   * @param sensor the touch sensor, eg: TouchSensor.T1
   */
  //% subcategory="Touch"
